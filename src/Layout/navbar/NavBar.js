        ...
        <div className='container mx-auto py-6 px-2 lg:grid gap-10 grid-cols-7 justify-between items-center'>
            ...
            <div className='col-span-3'>
                <form className='w-full text-sm bg-dryGray rounded flex-btn gap-4'>
                    <button type='submit' className='bg-subMain text-white w-12 flex-colo h-12 rounded'>
                        <FaSearch />
                    </button>
                    <input type='text' placeholder='Search your music from here' className='font-medium placeholder:text-border text-sm w-11/12 h-12 bg-transparent border-none px-2 text-black'></input>
                </form>
            </div>

            {/* Menu */}
            <div className='col-span-3 font-medium text-sm xl:gap-14 2xl:gap-20 justify-between lg:flex xl:justify-end items-center'>
                <NavLink to="/music" className={Hover}>Songs</NavLink>
